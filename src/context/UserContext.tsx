...
export const UserContext = createContext<[User, SetUser]>([initialUserState, () => null])

export const UserContextProvider = ({children}: {children: React.ReactNode}): React.ReactElement => {
